...
#file:best-practice.create-instructions.prompt.md
```
...
先に以下のプロンプトを実行してください：
#file:best-practice.official.prompt.md
```
...
先に以下のプロンプトを実行してください：
#file:best-practice.community.prompt.md
```
...
### 更新対象ファイルが見つからない場合
1. ファイルパスを確認
2. ユーザーに `#file:.github/prompts/best-practice.create-instructions.prompt.md` を実行するよう案内
3. 作業を中断
